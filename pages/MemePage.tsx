...
import { Dna, Gem, Gamepad2, Users, Repeat, Building, Layers, Wallet, Search, ChevronRight, ArrowUp, ArrowDown, Cpu, BrainCircuit, Flame, Rocket, Crown, History, Loader, Inbox, TrendingUp, MessageCircle, Wrench, Shield, Code, Eye, Package, Dice6, Vote, BarChart3, Gamepad, UserCheck } from 'lucide-react';
                ...
                <tbody>
                    {isLoading ? (
                        ...
                        projects.map((project, index) => {
                            ...
                            const sentimentScore = project.votes ? project.votes.up - project.votes.down : 0;
        ...
        if (sortConfig) {
            return [...filtered].sort((a, b) => {
                ...
                if (sortConfig.key === 'sentiment') {
                    aValue = a.votes ? a.votes.up - a.votes.down : 0;
                    bValue = b.votes ? b.votes.up - b.votes.down : 0;
