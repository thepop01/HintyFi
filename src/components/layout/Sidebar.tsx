...
const Sidebar: React.FC = () => {
  ...
  const isProjectPathActive = location.pathname.startsWith('/ecosystem') || location.pathname.startsWith('/early-projects');
  const isEventsPathActive = location.pathname.startsWith('/campaigns') || location.pathname.startsWith('/quest') || location.pathname.startsWith('/tasks') || location.pathname.startsWith('/this-week') || location.pathname.startsWith('/collabs');
      ...
      <div className="p-2 flex flex-col h-full overflow-y-auto overflow-x-hidden hide-scrollbar pt-4">
        <nav className="flex flex-col space-y-2">
          ...
          <CollapsibleMenu icon={<Calendar size={24} />} label="Events" isExpanded={isExpanded} isParentActive={isEventsPathActive}>
            ...
            <SubNavLink to="/collabs" label="Collabs" icon={<Sparkles size={16} />} isActive={location.pathname.startsWith('/collabs')} />
          </CollapsibleMenu>
