...
const ProjectCampaignsVerificationTab: React.FC = () => {
    ...
    useEffect(() => {
        const fetchCampaigns = async () => {
            ...
            const campaigns = (events || []).filter((e): e is CampaignEvent => e.type === 'campaign' && e.projectName === project.name);
    ...
    const handleSave = async (eventData: Partial<Event>, newStatus: Event['status']) => {
        const campaignToSave = {
            ...projectCampaigns.find(c => c.id === eventData.id),
            ...eventData,
            status: newStatus,
        } as Event;
