...
const Achievements: React.FC<AchievementsProps> = ({ user }) => {
    ...
    const {
        ...
        const achievements = Array.from(partnerProjectNames).map(projectName => {
            ...
            if (userNftHolding && project.nftCollections) {
                project.nftCollections.forEach(collection => {
                    ...
                    if (collection.pointsPerDay) pointsFromCollection += collection.pointsPerDay * userNftHolding.daysHeld;
        ...
        // Sort: achieved first, then alphabetically
    ...
    if (groupedAchievements.partner.length === 0) {
        return null;
    }
    ...
    return (
        ...
        >
            ...
            {renderSection("Partner Projects", groupedAchievements.partner)}
